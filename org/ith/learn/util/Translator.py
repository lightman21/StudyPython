...
def online_trans(str_input):
    url_encoded_str = urllib.parse.quote(str_input)
    cmd = """
    curl -v -H 'Host: tool.lu' -H 'Cookie: uuid=bd80d229-8633-4ada-cae2-3d67129b564c; Hm_lvt_0fba23df1ee7ec49af558fb29456f532=1585815731,1585820816; slim_session=%7B%22slim.flash%22%3A%5B%5D%7D; Hm_lpvt_0fba23df1ee7ec49af558fb29456f532=1585876205; _access=4248f7e60cd114d7010da848e1e4ddfe30efc1a81ffb9d652712700195c6fd9e' -H 'accept: application/json, text/javascript, */*; q=0.01' -H 'sec-fetch-dest: empty' -H 'x-requested-with: XMLHttpRequest' -H 'user-agent: Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/80.0.3987.149 Safari/537.36' -H 'content-type: application/x-www-form-urlencoded; charset=UTF-8' -H 'origin: https://tool.lu' -H 'sec-fetch-site: same-origin' -H 'sec-fetch-mode: cors' -H 'referer: https://tool.lu/zhconvert/' -H 'accept-language: zh-CN,zh;q=0.9,en-US;q=0.8,en;q=0.7' --data-binary "code={}&operate=zh-tw" --compressed 'https://tool.lu/zhconvert/ajax.html'
    """.format(url_encoded_str)

    ret_str = exec_cmd(cmd)
    dict_json = json.loads(ret_str)
    print(dict_json['text'])
    ...
    headers = {
        ':authority': "tool.lu",
        ':method': "POST",
        ':path': "/zhconvert/ajax.html",
        ':scheme': "https",
        'accept': "application/json, text/javascript, */*; q=0.01",
        'accept-encoding': "gzip, deflate, br",
        'accept-language': "zh-CN,zh;q=0.9,en-US;q=0.8,en;q=0.7",
        'content-type': "application/x-www-form-urlencoded; charset=UTF-8",
        'cookie': "slim_session=%7B%22slim.flash%22%3A%5B%5D%7D; uuid=bd80d229-8633-4ada-cae2-3d67129b564c; _access=4248f7e60cd114d7010da848e1e4ddfe0532952892b932b4a9beec5ad2ab7a68; Hm_lvt_0fba23df1ee7ec49af558fb29456f532=1585815731; Hm_lpvt_0fba23df1ee7ec49af558fb29456f532=1585815731",
        ...
        'content-length': str(len(url_encoded_str))
    }

    datas = {"code": url_encoded_str, "operate": "zh-tw"}
    response = requests.request('POST', url, data=datas, headers=headers)
    resp = response.text
    print(type(resp), resp)
    byts = bytes(resp, encoding="utf8")
    print(chardet.detect(byts))
    # text = urllib.parse.unquote(resp['text'])
    # print("urldecode:", text)
    # urllib.parse.unquote(s)


def to_simplized(str_input):
    rt_str = ''
    for i in range(len(str_input)):
        if str_of_tradition().find(str_input[i]) != -1:
            rt_str += str_of_simple()[str_of_tradition().find(str_input[i])]
        elif empty_str().find(str_input[i]) != -1:
            rt_str += str_of_simple()[empty_str().find(str_input[i])]
        else:
            rt_str += str_input[i]
...
def to_traditionalized(input_str):
    ret_str = ''
    for i in range(len(input_str)):
        if str_of_simple().find(input_str[i]) != -1:
            ret_str += str_of_tradition()[(str_of_simple().find(input_str[i]))]
        elif empty_str().find(input_str[i]) != -1:
            ret_str += str_of_tradition()[(empty_str().find(input_str[i]))]
        else:
            ret_str += input_str[i]
...
"""
curl -H 'Host: tool.lu' -H 'Cookie: uuid=bd80d229-8633-4ada-cae2-3d67129b564c; Hm_lvt_0fba23df1ee7ec49af558fb29456f532=1585815731,1585820816; slim_session=%7B%22slim.flash%22%3A%5B%5D%7D; Hm_lpvt_0fba23df1ee7ec49af558fb29456f532=1585876205; _access=4248f7e60cd114d7010da848e1e4ddfe30efc1a81ffb9d652712700195c6fd9e' -H 'accept: application/json, text/javascript, */*; q=0.01' -H 'sec-fetch-dest: empty' -H 'x-requested-with: XMLHttpRequest' -H 'user-agent: Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/80.0.3987.149 Safari/537.36' -H 'content-type: application/x-www-form-urlencoded; charset=UTF-8' -H 'origin: https://tool.lu' -H 'sec-fetch-site: same-origin' -H 'sec-fetch-mode: cors' -H 'referer: https://tool.lu/zhconvert/' -H 'accept-language: zh-CN,zh;q=0.9,en-US;q=0.8,en;q=0.7' --data-binary "code=%E8%BD%AF%E4%BB%B6&operate=zh-tw" --compressed 'https://tool.lu/zhconvert/ajax.html'
curl -H 'Host: tool.lu' -H 'Cookie: uuid=bd80d229-8633-4ada-cae2-3d67129b564c; Hm_lvt_0fba23df1ee7ec49af558fb29456f532=1585815731,1585820816; slim_session=%7B%22slim.flash%22%3A%5B%5D%7D; Hm_lpvt_0fba23df1ee7ec49af558fb29456f532=1585876205; _access=4248f7e60cd114d7010da848e1e4ddfe30efc1a81ffb9d652712700195c6fd9e' -H 'accept: application/json, text/javascript, */*; q=0.01' -H 'sec-fetch-dest: empty' -H 'x-requested-with: XMLHttpRequest' -H 'user-agent: Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/80.0.3987.149 Safari/537.36' -H 'content-type: application/x-www-form-urlencoded; charset=UTF-8' -H 'origin: https://tool.lu' -H 'sec-fetch-site: same-origin' -H 'sec-fetch-mode: cors' -H 'referer: https://tool.lu/zhconvert/' -H 'accept-language: zh-CN,zh;q=0.9,en-US;q=0.8,en;q=0.7' --data-binary "code=%E8%BD%AF%E4%BB%B6&operate=zh-tw" --compressed 'https://tool.lu/zhconvert/ajax.html'
"""


def curl_trans(str_input):
    url_encoded_str = urllib.parse.quote(str_input)
    cmd = """
       curl  -H 'Host: tool.lu' -H 'Cookie: uuid=bd80d229-8633-4ada-cae2-3d67129b564c; Hm_lvt_0fba23df1ee7ec49af558fb29456f532=1585815731,1585820816; slim_session=%7B%22slim.flash%22%3A%5B%5D%7D; Hm_lpvt_0fba23df1ee7ec49af558fb29456f532=1585876205; _access=4248f7e60cd114d7010da848e1e4ddfe30efc1a81ffb9d652712700195c6fd9e' -H 'accept: application/json, text/javascript, */*; q=0.01' -H 'sec-fetch-dest: empty' -H 'x-requested-with: XMLHttpRequest' -H 'user-agent: Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/80.0.3987.149 Safari/537.36' -H 'content-type: application/x-www-form-urlencoded; charset=UTF-8' -H 'origin: https://tool.lu' -H 'sec-fetch-site: same-origin' -H 'sec-fetch-mode: cors' -H 'referer: https://tool.lu/zhconvert/' -H 'accept-language: zh-CN,zh;q=0.9,en-US;q=0.8,en;q=0.7' --data-binary "code={}&operate=zh-tw" --compressed 'https://tool.lu/zhconvert/ajax.html'
       """.format(url_encoded_str)
    ret_str = exec_cmd(cmd, False)
    dict_json = json.loads(ret_str)
